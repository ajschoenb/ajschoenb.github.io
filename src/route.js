...
{ position: 'Charleston, WV', length: 1 },
...
{ position: 'New Haven, CT', length: 1 },
...
{ position: 'Port aux Basques, NL', length: 1 },
...
{ position: 'Newport, VT', length: 1 },
{ position: 'Montreal, QC', length: 2 },
{ position: 'Toronto, ON', length: 2 },
{ position: 'Ann Arbor, MI', length: 1 },
{ position: 'Pittsburgh, PA', length: 2 },
{ position: 'Columbus, OH', length: 1 },
{ position: 'Indianapolis, IN', length: 1 },
{ position: 'Louisville, KY', length: 1 },
{ position: 'St. Louis, MO', length: 1 },
{ position: 'Kansas City, KS', length: 1 },
{ position: 'Denver, CO', length: 2 },
{ position: 'Jackson, WY', length: 3 },
{ position: 'Rapid City, SD', length: 1 },
{ position: 'Omaha, NE', length: 1 },
{ position: 'Des Moines, IA', length: 1 },
{ position: 'Chicago, IL', length: 1 },
{ position: 'Madison, WI', length: 1 },
{ position: 'Minneapolis, MN', length: 1 },
...
{ position: 'Crescent City, CA', length: 1 },
{ position: 'Redding, CA', length: 1 },
